...
<div class="container">
    ...
    <div class="login-container">
      ...
      <div class="form-section">
        <button type="button" id="pilote-bouton" class="tab" onclick="showPiloteForm();">Pilote</button>
        <button type="button" id="sponsor-bouton" class="tab" onclick="showSponsorForm();">Sponsor</button>
      </div>
