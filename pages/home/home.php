...
<body>
  ...
  <div class="container">
        <img class="top_bkground" src="backgroundtop.png" alt="top_bkground">
        <div class="top">
            <h1>LA COURSE CONTINUE</h1>
            <h2>Retrouvez plus de 100 pilotes et sponsors sur FirstLap</h2>
            <a href="#Nos Pilotes"><button>Nos pilotes</button></a>
            <a href="#Nos Sponsors"><button>Nos sponsors</button></a>
        </div>
  </div>
  <main>
    ...
    <div class="pilotes">
      <a href="#Pilote1" class="image-link">
        <img src="pilote1.png" alt="pilote1">
      ...
      <a href="#Pilote2" class="image-link">
        <img src="pilote2.png" alt="pilote2">
        <span class="image-text">
      ...
      <a href="#Pilote3" class="image-link">
        <img src="pilote3.png" alt="pilote3">
        <span class="image-text">
        <p>Yann Ehrlacher</p>
        <p>Biographie</p>
        </span>
